...
SITE_ID = "Dharmalife"  
TARGET_VIEW_URLS = [
    "BeatVisitReportTB/sheets/Beatvisitemployeewise(June)",
    "BeatVisitReportTB/sheets/DailyBeatplanemployeewise(June)",
    "BeatVisitReportTB/sheets/BeatVisitbyrole"
]
...
<html>
  <body>
    <p>Dear Team,<br><br>
       Please find attached daily Beat Visit report for the month of June-2025.<br><br>
       Regards,<br>
       Tableau
    </p>
  </body>
