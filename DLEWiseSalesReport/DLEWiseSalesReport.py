...
SITE_ID = "Dharmalife"  
TARGET_VIEW_URLS = [
    "DLEandSHGsalesFY2025-2026TB/sheets/DLEDailySales(June)",
    "DLEandSHGsalesFY2025-2026TB/sheets/DLEWiseFY25-26"
]
...
<html>
  <body>
    <p>Dear Team,<br><br>
       Please find attached DLE Wise sales report for the month of June-2025.<br><br>
       Regards,<br>
       Tableau
    </p>
  </body>
